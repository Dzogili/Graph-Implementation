...
void ispisiMeni() {
	cout << "Operacije koje mozete da izaberete su:" << endl
		 << "1. Kreiranje strukture grafa, bez grana, za uneti broj cvorova. " << endl
		 << "2. Dodavanje jednog cvora sa zadatim indeksom. " << endl
		 << "3. Uklanjanje jednog cvora sa zadatim indeksom. " << endl
		 << "4. Dodavanje grana izmedju dva upisana cvora. " << endl
		 << "5. Brisanje grane izmedju dva upisana cvora. " << endl
		 << "6. Ispisivanje reprezentacije grafa. " << endl
...
int main() {
	...
	while (krajPrograma == false) {
		...
		case 3: {
			...
			string ime;
			g->dec();
			cout << "Unesite ime cvora koji zelite da izbacite: ";
			cin >> ime;
			g->ukloniElement(ime);
			g->ukloniIme(ime);
		...
		case 4: {
            ...
            cout << "Unesite prvog suseda: " << endl;
            cin >> a;

            cout << "Unesite drugog suseda: " << endl;
            cin >> b;
		...
		case 5: {
			...
			if (bool i = bezbedanCase(izbor,g) == false) break;
			int a, b;
			cout << "Unesite dva cvora izmedju kojih zelite da uklonite granu: " << endl;
			cin >> a >> b;
			g->brisiGranu(a, b);
